...
const DeleteDialog = () => {
  ...
  return (
    <div className="delete-popup absolute w-[70%] left-1/2 transform -translate-x-1/2 text-center py-4 rounded shadow-lg top-16 px-3 text-normal bg-slate-100 z-30">
      <h5 className="text-sm">Are you sure you want to remove this row? </h5>
      <div className="buttons flex mt-4 font-poppins text-sm mb-3 justify-center gap-4  ">
        <button
